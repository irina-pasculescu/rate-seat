...
class ArrayCookieJar implements CookieJarInterface, \Serializable
{
    ...
    public function remove( $domain = null, $path = null, $name = null )
    {
        ...
        $this->cookies = array_filter(
            $this->cookies, function ( Cookie $cookie ) use ( $cookies ) {
    ...
    {
        $this->cookies = array_filter(
            $this->cookies, function ( Cookie $cookie ) {
    ...
    public function removeExpired()
    {
        $currentTime   = time();
        $this->cookies = array_filter(
            $this->cookies, function ( Cookie $cookie ) use ( $currentTime ) {
    ...
    public function all( $domain = null, $path = null, $name = null, $skipDiscardable = false, $skipExpired = true )
    {
        return array_values(
            array_filter(
                $this->cookies, function ( Cookie $cookie ) use (
                    $domain,
                    $path,
                    $name,
                    $skipDiscardable,
