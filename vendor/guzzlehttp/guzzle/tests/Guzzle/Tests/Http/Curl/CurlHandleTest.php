...
class CurlHandleTest extends \Guzzle\Tests\GuzzleTestCase
{
    ...
    protected function updateForHandle( RequestInterface $request )
    {
        ...
        $request->getEventDispatcher()->addListener(
            'request.sent', function ( Event $e ) use ( $that ) {
    ...
    public function dataProvider()
    {
        ...
        $tests = array(
            // Send a regular GET
            array(
                'GET', 'http://www.google.com/', null, null, array(
            ...
            array(
                'TRACE', 'http://www.google.com/', null, null, array(
                CURLOPT_CUSTOMREQUEST => 'TRACE'
            )
            ),
            // Send a GET using a port
            array(
                'GET', 'http://127.0.0.1:8080', null, null, array(
                CURLOPT_RETURNTRANSFER => 0,
                CURLOPT_HEADER         => 0,
                CURLOPT_CONNECTTIMEOUT => 150,
                CURLOPT_WRITEFUNCTION  => 'callback',
            ...
            // Send a HEAD request
            array(
                'HEAD', 'http://www.google.com/', null, null, array(
                CURLOPT_RETURNTRANSFER => 0,
                CURLOPT_HEADER         => 0,
                CURLOPT_CONNECTTIMEOUT => 150,
                CURLOPT_HEADERFUNCTION => 'callback',
            ...
            array(
                'GET', 'https://michael:123@localhost/index.html?q=2', null, null, array(
                CURLOPT_RETURNTRANSFER => 0,
                CURLOPT_HEADER         => 0,
                CURLOPT_CONNECTTIMEOUT => 150,
                CURLOPT_WRITEFUNCTION  => 'callback',
            ...
            array(
                'POST', 'http://localhost:8124/post.php', null, $qs, array(
                CURLOPT_RETURNTRANSFER => 0,
                CURLOPT_HEADER         => 0,
                CURLOPT_CONNECTTIMEOUT => 150,
                CURLOPT_WRITEFUNCTION  => 'callback',
            ...
            array(
                'PUT', 'http://localhost:8124/put.php', null, EntityBody::factory( fopen( $testFile, 'r+' ) ), array(
                CURLOPT_RETURNTRANSFER => 0,
                CURLOPT_HEADER         => 0,
                CURLOPT_CONNECTTIMEOUT => 150,
                CURLOPT_WRITEFUNCTION  => 'callback',
            ...
            array(
                'POST', 'http://localhost:8124/post.php', null, array(
                'x' => 'y',
                'a' => 'b'
            ), array(
                    CURLOPT_RETURNTRANSFER => 0,
            ...
            array(
                'POST', 'http://localhost:8124/post.php', array(
            ...
            array(
                'POST', 'http://localhost:8124/post.php', null, array(), array(
                CURLOPT_CUSTOMREQUEST => 'POST',
                CURLOPT_HTTPHEADER    => array(
                    'Expect:',
                    'Accept:',
            ...
            array(
                'PATCH', 'http://localhost:8124/patch.php', null, 'body', array(
            ...
            array(
                'DELETE', 'http://localhost:8124/delete.php', null, 'body', array(
             ...
             */
            array(
                'GET', 'http://www.google.com#head', null, null, array(
                CURLOPT_RETURNTRANSFER => 0,
                CURLOPT_HEADER         => 0,
                CURLOPT_CONNECTTIMEOUT => 150,
                CURLOPT_WRITEFUNCTION  => 'callback',
        ...
        $postTest = array(
            'POST', 'http://localhost:8124/post.php', null, $postBody, array(
                CURLOPT_RETURNTRANSFER => 0,
                CURLOPT_HEADER         => 0,
                CURLOPT_CONNECTTIMEOUT => 150,
                CURLOPT_WRITEFUNCTION  => 'callback',
    ...
    public function testSendsPostFieldsForNonPostRequests()
    {
        ...
        $client  = new Client();
        $request = $client->put(
            $this->getServer()->getUrl(), null, array(
                                            'foo' => 'baz',
                                            'baz' => 'bar'
                                        )
        );
